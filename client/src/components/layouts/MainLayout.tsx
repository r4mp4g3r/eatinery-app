        ...
        <div className="max-w-screen-xl mx-auto px-4 py-4 flex justify-between items-center">
          <Link href="/">
            <a className="flex items-center">
              ...
              <h1 className="font-heading font-bold text-lg text-neutral-800">HealthEats</h1>
            </a>
          </Link>
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="flex justify-around py-2">
            ...
            <button className="flex flex-col items-center p-2">
              ...
              <span className="text-xs font-medium text-neutral-500 mt-1">Search</span>
            </button>
            
            <button className="flex flex-col items-center p-2">
              <ShoppingBag className="h-6 w-6 text-neutral-400" />
              <span className="text-xs font-medium text-neutral-500 mt-1">Orders</span>
            </button>
            
            <button className="flex flex-col items-center p-2">
              <User className="h-6 w-6 text-neutral-400" />
              <span className="text-xs font-medium text-neutral-500 mt-1">Profile</span>
            </button>
          </div>
        </div>
      </div>
